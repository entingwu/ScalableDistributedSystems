...
public class ConnectUtils {
    ...
    private static final String CONNECTION_UTILS = ConnectUtils.class.getName();
    ...
    public static Connection getConnection() {
        try {
            ...
            Logger.getLogger(CONNECTION_UTILS).log(Level.SEVERE, null, e);
        }
        ...
        try {
            ...
            Logger.getLogger(CONNECTION_UTILS)
    ...
    public static void closeConnection(Connection connection) {
        try {
            ...
            Logger.getLogger(CONNECTION_UTILS).log(Level.SEVERE, null, ex);
        }
    }
}
